...
== Compte rendu
voici les commandes utilisés lors du tp: 
-mvn clean : permetant de remettre a zero l'espace de travail
-mvn compile : permetant de compiler notre espace de travail et la classe detaillée dans pom.xml
-mvn package : permetant de creer le fichier de notre espace de travail
-mvn java -jar target/tp_qualite-1.0.jar : permetant d'executer la nouvelle application
-mvn site : permetant de generer une documentation sur un site web

Ces commandes nous ont permis d'utiliser un espace de travail java diferent que notre ide habituel pour réaliser des taches sur un programme java